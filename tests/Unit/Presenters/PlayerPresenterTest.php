...
class PlayerPresenterTest extends TestCase
{
    protected $presenter;
    ...
    {
        $this->assertInstanceOf(PlayerPresenter::class, $this->presenter);
    ...
    public function test_get_transformer_returns_correct_transformer(): void
    {
        ...
        $this->assertInstanceOf(PlayerTransformer::class, $transformer);
    }
