...
class GameCreateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new GameCreateRequest();
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(GameCreateRequest::class, $this->request);
    }
    ...
    public function test_rules_contain_required_fields(): void
    {
        ...
        $this->assertArrayHasKey('home_team_id', $rules);
        $this->assertArrayHasKey('visitor_team_id', $rules);
    }
